...
2,023,070 ovservations 4 variables
1210271 users  249274 items
...
The final ratings matrix for this project contains 10,227 users and 11,209 items/prooducts. There are 111,871 ratings.
...
# Train/test split
set.seed(88)
eval <- evaluationScheme(amazon, method = "split", train = 0.8, given = -1, goodRating = 3)
